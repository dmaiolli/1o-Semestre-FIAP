...
public class AlunoTeste {
	...
	public static void main(String[] args) {
		...
		String precisaFinal = avFinal == 0 ? "O aluno não precisa realizar a avaliação final" : "O aluno precisa obter " + formataNota.format(avFinal) + "pontos para continuar sua jornada";
		
		
		String resultado = "O aluno" + aluno.getNome() + " ficou com a média " + formataNota.format(media) + "./n" + precisaFinal;
