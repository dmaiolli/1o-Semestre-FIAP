...
public class Data {
	...
	public int compara(Data data) {
		int difAno = this.ano - data.getAno();
		int difMes = this.mes - data.getMes();
		int difDia = this.dia - data.getDia();
	...
	public String toString() {
		...
		return doisDigitos.format(dia) + "/" + doisDigitos.format(mes) + "/" + quatroDigitos.format(ano);
	}
}